    ...
    data_type=AttributePattern.from_dict(
        {
            ...
            "VehicleInformation": [
                "vehicle(.){0,20}(information|data|detail)",
            ],
            "VehicleID": [
                "vehicle ID",
                "vehicle identifier",
            ...
            "OilLevel": ["\\boil level", "\\boil life\\b"],
            "TirePressure": ["\\btire pressure"],
            "FuelEconomy": ["\\bfuel economy"],
            "OdometerReadings": [
                "odometer reading(s)?",
                "mileage",
                "distance traveled",
            ...
            "SeatBeltUse": [
                "seat belt use",
                "seat belt usage",
                "seat belt (data|information)",
            ],
            "BreakingHabits": ["breaking habit(s)?", "breaking pattern(s)?"],
            "CollisionData": [
                "collision (data|information|detail)",
            ...
            "StudentID": ["student ID", "student identifier"],
            ...
            "IrisData": ["iris (data|information)", "retina"],
            "VeinData": ["vein pattern"],
...
EN_DATE_PATTERN_CONFIG: DatePattern = DatePattern(
    {
        ...
        "%m/%d/%Y": "\\b(?:0?[1-9]|1[0-2])/\\d{1,2}/\\d{4}\\b",
        "%m-%d-%Y": "\\b\\d{1,2}-\\d{1,2}-\\d{4}\\b",
        "%d.%m.%Y": "\\b\\d{1,2}\\.\\d{1,2}\\.\\d{4}\\b",
        "%d/%m/%Y": "\\b\\d{1,2}/\\d{1,2}/\\d{4}\\b",
        "%d-%m-%Y": "\\b\\d{1,2}-\\d{1,2}-\\d{4}\\b",
        "%B %d, %Y": "\\b(?:January|February|March|April|May|June|July|August|September|October|November|December)\\s+\\d{1,2}(?:st|nd|rd|th)?,?\\s+\\d{4}\\b",
        "%d %B %Y": "\\b\\d{1,2}\\s+(?:January|February|March|April|May|June|July|August|September|October|November|December)\\s+\\d{4}\\b",
        "%b %d, %Y": "\\b(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)[a-z]*\\.?\\s+\\d{1,2}(?:st|nd|rd|th)?,?\\s+\\d{4}\\b",
