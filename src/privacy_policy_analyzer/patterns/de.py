    ...
    data_type=AttributePattern.from_dict(
        {
            ...
            "GeneralInformation": ["allgemeine[rn]?(-.{0,27})? (Daten|Details)\\b"],
            "PII": [
                "\\bPII\\b",
            ...
            "AppVersion": ["App(-.{0,27})?(?<!SDK-)version", "Version der.{0,20}Apps?"],
            ...
            "MobileNetworkData": [
                "mobilen? Netzwerk(-(?!.*Code).{0,81}| )?(daten|informationen)"
            ],
            "MobileNetworkCode": [
                "Mobilfunknetzcode",
            ...
            "WiFiData": ["(Wi(-)?Fi|WLAN)[- ](Daten|Informationen|ID)"],
            ...
            "EngagementMetrics": [
                "Engagement[- ](Daten|Informationen|Metriken|Statistiken|Kennzahlen)"
            ],
            ...
            "OnlineStatus": ["Onlinestatus", "ob Sie online sind"],
            ...
            "Keystrokes": ["Tastenanschläge", "Tastatureingabe"],
            "SearchHistory": ["Such(verlauf|historie|begriffe)", "Suchanfrage"],
            "PageInteractions": [
                "Seiten?[- ]?Interaktion",
            ...
            "DeviceEvents": ["Geräte?-(Event|Ereignis)", "ausgelöste Aktivitäten"],
            "DeviceAlerts": [
            ...
            "RandomID": ["zufällige ID", "Zufalls-ID"],
            ...
            "ScrollData": ["Scroll-?daten", "scrollen"],
            "Clickstream": ["click( )?stream", "Klickverhalten", "Klicktracking"],
            "PageResponseTime": [
                "Seiten?[- ]?Reaktionszeit",
                "Reaktionszeit.{0,20}(Seite|Website|Webseite)",
            ],
            ...
            "AltitudeData": ["Höhendaten", "Erhöhungsdaten"],
            "Timezone": ["Zeitzonen?"],
            "Address": [
            ...
            "EmploymentBackground": [
                "Ihr(es|en|em) Hintergrunds?(Hintergrund|Referenzen).{0,20}Bewerber",
            ...
            "Ethnicity": ["Ethnien?", "ethnische[rn]? Herkunft"],
            ...
            "PermissionsData": ["\\bZugriffsrechte"],
            ...
            "NotificationPermissions": [
                "\\bBenachrichtigungs(zugriffsrechte|berechtigung)\\b"
            ],
            ...
            "AmbientLightData": ["Umgebungslicht", "Lichtmesswert"],
            ...
            "SmokeData": ["\\bRauch"],
            "OutdoorData": [
                "outdoor-(Informationen|Daten|Details)",
                "Außen-?(Informationen|Daten|Details)",
            ],
            ...
            "CleaningHistory": [
                "Clean(er|ing)-(Verlauf|Historie)",
                "Reinigungs(verlauf|historie)",
            ],
            ...
            "FloorType": [
                "Boden(-.{0,27})?(art|typ|belag)",
                "(Art|Typ|Belag).{0,20}Boden",
            ],
            "ObjectData": [
            ...
            "HealthData": ["(?<!öffentliche )(?<!öffentlichen )(Gesundheit)(?!status)"],
            "HealthStatus": ["Gesundheits(.{0,27})?status"],
            "SleepData": ["Schlaf(daten|information)"],
            "CoughingData": ["Husten"],
            ...
            "FinancialData": ["Finanz(-.{0,27})?daten", "persönliche[rn]? Finanzen"],
            ...
            "MembershipData": ["Mitglied(s|er)(daten|informationen|details|status)"],
            "Maps": [
                "(?<!Kredit)(?<!SIM-)Karten\\b",
            ],
            "MapAreaNames": [
            ...
            "TouchData": [
                "\\bTouch(screen)?(-.{0,27})?(daten|informationen|interaktionen|signale)"
            ],
            "VoiceCommands": ["Sprachbefehle?"],
            "VoiceCharacteristics": [
                "Stimm(en)?(merkmale|eigenschaften|charakteristik(en|a))"
            ],
            ...
            "Submissions": ["Ihre[rn]? Einreichung(en)?", "Einsendungen"],
            "Feedback": ["((Be)?nutzer)?Feedback", "Rückmeldungen", "Vorschläge"],
            "Comments": ["Kommentare?", "Kommentarfeld"],
            "Opinions": [
            ...
            "Password": ["Passwort"],
            "AuthToken": ["Authentifizierungs-?token", "Auth Tokens?"],
            "WrittenPermissions": [
            ...
            "EmployeeRecord": [
                "(Mitarbeiter|Personal|Angestellten)-?(akte|aufzeichnungen)"
            ],
            "OrderData": [
            ...
            "PurchaseDate": ["Kauf(-.{0,27})?datum", "Datum.{0,30}Kauf"],
            "PaymentData": [
                "Zahlungs(-.{0,27})?(daten|informationen|details|aufzeichnungen|datensätze)"
            ],
            "PaymentAmount": [
            ...
            "BillingData": [
                "Abrechnungs(-.{0,27})?(daten|informationen|details|datensätze)"
            ],
            "BillingReceipts": ["(Rechnungs|Abrechnungs|Zahlungs|Kauf)beleg"],
            "TransactionData": ["Transaktions(-.{0,27})?(daten|informationen|details)"],
            "TransactionHistory": ["Transaktions(-.{0,27})?(historie|verlauf)"],
            "InAppTransactions": ["in(-| )app-(Transaktionen|Käufe)"],
            "ShippingInformation": [
                "(Liefer(ungs|anten)?|Versand)(-.{0,27})?(information|daten)"
            ],
            ...
            "CreditCardNumber": ["Kredit(karten)?(-.{0,27})?nummer"],
            "DebitCardInformation": [
                "debit(-.{0,27})?Karten(information|daten|details|nummer)"
            ],
            "BankAccountInformation": ["Bankkonto(informationen|daten|details)"],
            "BankAccountNumber": ["(?<!-)(Konto|Bank)(-.{0,27})?nummer", "IBAN"],
            "BankHolderName": [
            ...
            "ListedItems": [
                "(gelisteter?|aufgeführter?) (Artikel|Sachen|Waren|Produkte)"
            ],
            "Likes": ["\\blikes\\b", "Gefällt[- ]mir"],
            "Follows": ["Follower"],
            ...
            "VirusDefinitions": ["Virendefinitionslisten", "Virusdefinition"],
            "DeviceAutomations": ["Geräte(-.{0,27})?automatisierung"],
            "ContestData": [
                "Wettbewerbs(-.{0,27})?(daten|informationen|details|hinweise|einträge)"
            ],
            "BusinessInformation": [
            ...
            "Title": ["Titel", "akademische[rnm]? Grad"],
            "FaxNumber": ["Fax(-.{0,27})?nummer"],
            "PersonalAssistants": ["persönliche[nrm]? Assistenten"],
            "FontType": ["(Font|Schrift)(-.{0,27})?art", "Fonts?"],
            "Badges": ["Badges"],
            "Favorites": ["Favoriten"],
            ...
            "GeneticData": ["genetische (Daten|Informationen|Details|Merkmale|Marker)"],
    ...
    method_source=AttributePattern.from_dict(
        {
            ...
            "Feedback": ["\\bFeedback\\b", "Befragung", "Frage(bogen|bögen)"],
            "Tracking": ["\\bVerfolgung", "Cookie", "Tracking"],
        }
    ),
    descriptive=AttributePattern.from_dict(
        {
            ...
            "Vendor": ["(Einzel)?Händler", "Verkäufer"],
            "Supplier": [
                "\\bLieferant(en)?\\b",
            ...
            "SubContractors": ["\\bUnterauftragnehmer\\b", "Subunternehmer"],
            "Adviser": ["Beratern?\\b"],
            "Buyer/Investor": [
            ...
            "RatingPlatform": ["Bewertungsplattform"],
            "RecruitmentPlatform": ["Rekrutierungs(plattform|portal)"],
            "MarketingAffiliate": ["Marketing-?Partner"],
            "AdvertisingAgency": [
                "\\bWerbe(agentur|treibende)",
                "Marketing-Drittanbieter",
                "(Drittanbieter|Dienstleister|Partei)(?=.*Werbung)",
            ],
            "AdvertisingNetwork": ["Werbenetzwerk"],
            "AdvertisingPartner": [
                "\\bWerbepartnern?\\b",
                "\\bMarketing[- ]?Partnern?\\b",
            ],
            "SoftwareDeveloper": ["Softwareentwickler", "App-Entwickler"],
            ...
            "NetworkOperator": ["Netzwerkbetreib(er|ende)"],
            "EcosystemCompanies": [
            ...
            "DataController": ["Datenverantwortliche[rn]?"],
            "AttributionCompanies": ["(Attributions|Zurechnungs)unternehmen"],
            "ThirdPartyEmployee": [
            ...
            "ECommercePlatform": ["E-Commerce-Plattform", "Handelsplattform"],
            "EmailServiceProvider": [
                "E-Mail[- ](Anbieter|Dienst(leister|anbieter)|Provider)"
            ],
            ...
            "Insurer": ["Versicherungen", "Versicherer"],
            ...
            "Sponsor": ["Sponsor"],
            "Promoter": ["Promoter"],
            "EventOrganiser": ["Veranstalter", "Organisator(en|s)?\\b"],
    ...
    official=AttributePattern.from_dict(
        {
            ...
            "EmergencyServices": ["\\bNot(fall)?dienste?\\b", "Katastrophenschutz"],
            ...
            "PublicHealthAuthorities": ["Gesundheits(behörde|amt)"],
            ...
            "FinancialRegulators": ["Finanzaufsichtsbehörde"],
    ...
    country=AttributePattern.from_dict(
        {
            ...
            "EEA": ["\\bEWR\\b", "\\bEuropäische[rn] Wirtschaftsraums?\\b"],
            "Asia": ["\\bAsiens?\\b"],
            "Africa": ["\\bAfrikas?\\b"],
            ...
            "AndOther": ["andere Länder", "andere[sn] Land"],
            ...
            "North Korea": [
                "\\bNordkoreas?\\b",
                "\\bDemokratischen? Volksrepublik Korea\\b\\bDVRK\\b",
            ],
            "Taiwan": ["\\bTaiwans?\\b"],
    ...
    provide_service=AttributePattern.from_dict(
        {
            ...
            "AfterSalesService": ["Nachlieferung", "nach einer Bestellung"],
            "PresentWebsite": [
            ...
            "Loaning": ["Verleih", "Ausleih(ung|en)?"],
            "RiskAssessment": [
                "\\bRisiko(bewertung|berücksichtigung|management)",
                "(berücksichtigen|bewerten).{0,110}Risik(o|en)",
            ],
            "Insurance": ["\\bVersicherung(en)?\\b", "Versicherungs(antrag|anträgen)"],
            ...
            "FraudRiskScoring": ["Betrugserkennung", "Betrugsrisikobewertung"],
            "Comfort": [
                "bequem",
            ...
            "SyncContent": ["(Synchronisation|synchronisieren)"],
            "LocalizeContent": [
                "\\bgeo(-)?targeting\\b",
                "regionale Adresse",
            ...
            "CountVisits": ["Besucher(an)?zahl", "Besucher(.){0,32}zählen"],
            "RecommendSettings": [
                "(empfohlene|vorgeschlagene).{0,32}(Einstellung|Konfiguration)",
            ],
            "ProvideUsageInsights": ["Nutzungseinblicke", "Einblicke? in die Nutzung"],
            "Logging": [
                "\\blogging\\b",
            ...
            "AutomaticPurchases": ["automatischer?.{0,32}(Lieferung|Kauf|Abwicklung)"],
            ...
            "BackupService": ["Backup-?(dienst|service)", "^(?!.*lösch).*Backups"],
            ...
            "OptimizeWifFi": [
                "(wi-?fi|Wlan|Internetverbindung) zu (optimieren|verbessern)"
            ],
            "SwitchLight": ["Licht (ein|aus)(zu)?schalten"],
            "Invoice": [
            ...
            "SmartHomeFunctions": ["Smart-Home(?!-Plattform)"],
            "ObjectDetection": [
                "Objekterkennung",
            ...
            "RepairService": ["Reparatur", "reparieren"],
            "ConsentManagement": [
            ...
            "SelfService": ["Self-Service", "Kundenportal"],
    ...
    communication=AttributePattern.from_dict(
        {
            ...
            "Reminders": ["reminder", "Erinnerung", "Sie.{0,24}zu erinnern"],
            "Feedback": ["Feedback", "Rückmeldung(en)?", "Vorschläge"],
            "Review": [
                "\\breview(s)?\\b",
            ...
            "ChatBot": ["\\bchat(-)?bot\\b", "\\bVirtueller Assistent\\b"],
            "LiveChat": ["\\bLive[- ]Chat\\b", "\\bEchtzeit[- ]Chat\\b"],
            "AccountVerification": [
            ...
            "EmergencyContact": [
                "Notfall-?(Warnung|Hinweis|Meldung|Nachricht|kontakt)"
            ],
            "ErrorReporting": [
    ...
    chosen=AttributePattern.from_dict(
        {
            ...
            "AppointedRepresentatives": ["(bestellte|benannte)[rnm]? Vertreter"],
            "LegalRepresentative": [
                "gesetzliche[rn]? Vertreter",
                "gesetzlich vorgeschriebener?.{0,48}(Partei(en)?|Person(en)?|Vertretern?)\\b",
            ],
            "Caregiver": ["Pflege(r|rin|kraft)", "(?<!Kunden)Betreu(er|rin|ungskraft)"],
            "Invitee": ["eingeladene (Person|Mitglieder|Nutzer)", "Eingeladene[rn]?"],
            "Proxy": ["Proxy", "Stellvertret(er(in)?|ender?)"],
            "LegalGuardian": ["Erziehungsberechtigte[rns]?", "gesetzliche[rn] Vormund"],
            "AuthorizedUser": ["(berechtigte|autorisierte)[rn]? (Be)?Nutzer"],
            "TrustedIndividual": ["vertrau(ten|enwürdige[rn]?) (Person|Kontakt)"],
            "DesignatedAdministrator": [
                "(bestellte|beauftrage)[rn]? (Verwalter|Administrator)"
            ],
